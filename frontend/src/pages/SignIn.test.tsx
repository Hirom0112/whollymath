...
// CLAUDE.md §9). These pin its contract with the App flow: it offers both ways in, and
// choosing one hands off the chosen method to onContinue after the mascot's roll-out.
