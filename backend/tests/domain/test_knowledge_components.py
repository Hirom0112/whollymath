...
EXPECTED_GRADE6_KCS = {
    ...
    # U4 — Expressions (6.EE.1–4, 6). KC_write_expressions (first expression-answer KC) and
    # KC_evaluate_expressions (6.EE.2c, masterable numeric) moved to EXPECTED_CATALOG_IDS
    # (built 2026-05-30).
    "KC_exponents",
    "KC_expression_parts",
