...
def test_area_model_is_the_same_item_masterable_without_a_figure_yet() -> None:
    ...
    masterable (>=2 reps). Pictureless for now — the triangle figure isn't drawn (no scene deriver);
    the INTEGER_MULTIPLY_DIVIDE precedent. Drawing it (FigureStimulus) is frontend follow-up."""
