...
def create_app() -> FastAPI:
    ...
    # The parent-account endpoints (Slice auth/parent-child): email/password signup + login,
    # cookie-borne sessions with CSRF, COPPA email verification, and (next sub-slices) the
